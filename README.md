...
| Matrix engines | Four engines per CU; wave32; M16N16K16 FP16/BF16 and M16N16K32 FP8/INT8; fixed fragment map, 16-cycle issue target, bank-safe control RTL, and pending-destination matrix interlocks | [Matrix Engine Architecture](docs/MATRIX_ENGINE.md) |
