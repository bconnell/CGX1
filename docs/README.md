...
| [Matrix Engine Precision and Semantics](MATRIX_ENGINE.md) | FP16, BF16, OCP FP8 and INT8 numeric behavior, accumulation and capability discovery | You are implementing matrix RTL, compiler lowering or API exposure |
