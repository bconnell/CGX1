...
| RTL | Limited control/storage/arithmetic RTL | Power-state/tile-enable scaffold, matrix control, staging, per-wave VGPR scoreboard, and signed INT8 matrix arithmetic; FP16/BF16/FP8 arithmetic, physical storage macros, ordinary vector execution integration, and multi-wave scheduling remain open |
