...
| RTL | Limited control/storage/arithmetic RTL | Power-state/tile-enable scaffold, matrix control, staging, per-wave VGPR scoreboard, standalone signed INT8 arithmetic, and an implemented signed INT8 end-to-end path awaiting exact-revision integration simulation; FP16/BF16/FP8 arithmetic and physical implementation remain open |
