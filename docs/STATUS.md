...
| RTL | Limited control/staging RTL + executable simulation | Power-state/tile-enable scaffold, matrix pipeline controller, and matrix capture/active operand staging; arithmetic datapath, output-result staging, physical storage macros, and general compute-unit scoreboard remain open |
