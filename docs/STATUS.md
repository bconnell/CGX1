...
| Matrix engine architecture | Defined numeric + physical execution contract with executable references | [Matrix Engine Architecture](MATRIX_ENGINE.md) and [source/matrix](../source/matrix/) |
