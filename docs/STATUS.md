...
| RTL | Limited control RTL + executable simulation | Power-state/tile-enable scaffold plus matrix pipeline controller; arithmetic datapath and physical register/staging implementation remain open |
