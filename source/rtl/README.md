...
The public RTL currently contains three limited, separately testable boundaries:
...
The matrix RTL does **not** implement FP16, BF16, FP8, or INT8 arithmetic. It also does not implement output-result staging, physical VGPR/storage macros, cross-lane arithmetic delivery wiring, or the general compute-unit scoreboard needed to interlock ordinary non-matrix instructions.
